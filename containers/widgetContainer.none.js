...
WA.Containers.widgetContainer = function(domNodeFather, domID, params, notify, _4glNode)
{
  var self = this;
  WA.Containers.widgetContainer.sourceconstructor.call(this, domNodeFather, domID, params, notify, _4glNode, { classname:'widget', classnamezone:'widgetzone' }, 'div');
...
WA.Containers.widgetContainer.widgetZone = function(maincontainer, domID, params, notify)
{
  var self = this;
